...
\begin{empheq}[]{align*}
    ...
    \cdot \underbrace{cos(\omega t \overbrace{-}^{\mathclap{\text{positive z-Richtung}}} k z)}_\text{Zeit- und Raumabhängigkeit (Wellenzahl)}
    \cdot\vec{e}_z}
\end{empheq}
...
\[
    v_p = \dfrac{\omega}{k} = \frac{1}{\sqrt{ \mu_r \mu_0 \varepsilon_r \varepsilon_0}} \qquad v_{p,\texttt{Medium} \leq c_0}
\]
...
\begin{align*}
    ...
    \Aboxed{\underline{Z}_F & = \dfrac{\underline{E}}{\underline{H}} = \sqrt{\dfrac{j\omega\mu}{\kappa+j\omega\varepsilon}} = \dfrac{1}{n}\sqrt{\dfrac{\mu_0}{\varepsilon_0}}}                                              \\
\end{align*}
...
\begin{align*}
    \alpha                  & = 0                                                                                              \\
    k                       & = \dfrac{\omega}{c_0}\sqrt{\mu_r\varepsilon_r}=\omega\sqrt{\mu\varepsilon}=\dfrac{2\pi}{\lambda} \\
...
geringer Verlust: $\kappa \gg\omega\varepsilon$
\begin{align*}
...
\begin{align*}
    ...
    S_{AV}              & =  \frac{1}{2} \cdot E \cdot H = \frac{1}{2} \cdot \dfrac{E^2}{Z_{F0}} = \\
...
\begin{align*}
    t  &= \left(\frac{2 \cdot \sqrt{Z_{F1} Z_{F2}}}{Z_{F1} + Z_{F2}}\right)^2 = \left(\frac{2 \cdot \sqrt{n_1 n_2}}{n_1 + n_2}\right)^2\\ 
    r  &= \left(\frac{Z_{F2} - Z_{F1}}{Z_{F1} + Z_{F2}}\right)^2 = \left(\frac{n_1 - n_2}{n_1 + n_2}\right)^2\\
    n^2 &= \epsilon_r \cdot \mu_r\\
    0<t&<2 \qquad 0<|r|<1
\end{align*}
...
\begin{align*}
    ...
    t_e            & = 1+ r_e ??
    t_e &= \dfrac{2 \cdot n_2}{n_1 + n_2}\\
    r_e &= \dfrac{n_2 - n_1}{n_1 + n_2}
\end{align*}
