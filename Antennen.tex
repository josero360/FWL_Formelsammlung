...
\begin{align*}
    P_{S} & = \frac{Z_{F0} {I_0}^2 \beta^2 (\Delta l')^2}{12\pi}                             \\
    ...
    S_{av}         & = \frac{Z_FI_0^2\beta^2(\Delta l')^2}{32\pi^2R^2}\cdot\sin^2\theta\cdot\vec{e}_R \\
                   & = \frac{1}{2} \hat{E}\cdot\hat{H} = \frac{1}{2} \frac{\hat{E}^2}{Z_{F}}
\end{align*}
\subsubsection{Strahlungswiderstand}
\begin{align*}
    R_{S} & = \frac{2}{3}\pi \cdot Z_F\left(\frac{\Delta l'}{\lambda}\right)^2
...
\begin{align*}
    P_V & = \frac{1}{2}\cdot I_A^2\cdot R_V \qquad R_{V} = \frac{l}{\sigma\cdot A}
\end{align*}
...
Dipol mit Länge $l_D = \lambda$ oder $= \frac{\lambda}{2}$ $\dots$
\begin{align*}
    C(\vartheta)     & = \left| \frac{\cos(\pi\cdot \left(\frac{l_D}{\lambda}\right) \cdot \cos(\vartheta))}{\sin(\vartheta)} \right|
\end{align*}

\subsubsection{Richtfunktion/Richtfaktor}
In $[\si{dB}]$ angeben!
\begin{align*}
    D(\vartheta, \varphi) & = \frac{S(\vartheta, \varphi)}{S_{i}} = C_{i}^{2}(\vartheta, \varphi) \\
    D(\vartheta)          & = D_0 \cdot C^{2}(\vartheta) = \frac{G}{\eta} \\
    D_0                   & = \max \{D(\vartheta, \varphi)\} = \frac{S_{\max}}{S_{i}}
\end{align*}
...
\begin{align*}
    \frac{P_{E}}{P_{S}}          & = A_{\texttt{eff},E}\cdot A_{\texttt{eff},S}\cdot\frac{1}{\lambda^2r^2}                          \\
                                   & = D_{i,E}\cdot\eta_{E}\cdot D_{i,S}\cdot\eta_{S}\cdot\left(\frac{\lambda}{4\pi r}\right)^2     \\
    \Aboxed{A_\texttt{eff}(\theta) & = G_{E}\cdot\frac{\lambda^2}{4\pi}\overbrace{\cdot\frac{3}{2}\cdot\sin^2\theta}^{{D_{i,\theta}}}} \\
    P_{E}                         & = S_{E}\cdot A_\texttt{eff}                                                                       \\
                                   & = P_{S}\cdot G_{S}\cdot G_{E}\cdot \left(\frac{\lambda}{4\pi r}\right)^2
\end{align*}

\subsubsection{Empfangene Leistungsdichte}
\begin{align*}
    S_E &= \frac{P_S}{4 \pi r^2} \cdot G_S
\end{align*}
...
\begin{align*}
    ...
    L_{E} & = L_{S}+g_{S}+g_{E}-a_{0} \qquad [\si{dB}]
\end{align*}
