...
\subsubsection{Reflexionsfaktor entlang der Leitung}
\begin{align*}
    \underline{r}(\ell) & = \underline{r}(\ell=0) \cdot \mathrm{e}^{-2 \underline{\gamma} \ell}=\underline{r}(\ell=0) \cdot \mathrm{e}^{-2 \alpha \ell} \cdot \mathrm{e}^{-\mathrm{j} 2 \beta \ell}\\
...
\subsubsection{Spezialfall: Beliebiger Abschluss}
\begin{align*}
    \underline{U}(\ell) &= \underline{U}_2\left[\cos (\beta \ell)+\mathrm{j} \frac{\underline{Z}_L}{\underline{Z}_A} \sin (\beta \ell)\right] \\
    \underline{I}(\ell) &= \underline{I}_2\left[\cos (\beta \ell)+\mathrm{j} \frac{\underline{Z}_A}{\underline{Z}_L} \sin (\beta \ell)\right] \\
...
\begin{align*}
    ...
    m                 & = \frac{1}{\mathrm{SWR}} = \frac{1 - |r(z)|}{1 + |r(z)|}
\end{align*}
